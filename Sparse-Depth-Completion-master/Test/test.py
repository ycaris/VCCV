...
def main():
    ...
    best_file_name = glob.glob('/Users/jamiezhou/Desktop/mlproject/Sparse-Depth-Completion-master/Saved/model_best_epoch.pth.tar')[0]
    ...
    if os.path.isfile(best_file_name):
        ...
        checkpoint = torch.load(best_file_name, map_location=torch.device('cpu'))
